...
namespace SinDinero.Migrations
{
    ...
    [Migration("20260617160914_AddMonthlySummary")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SinDinero.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SinDinero.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SinDinero.Models.MonthlyCategorySummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SinDinero.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SinDinero.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SinDinero.Models.MonthlyCategorySummary", b =>
                {
                    b.HasOne("SinDinero.Models.Category", "Category")
                        .WithMany()
